...
groud truth and predictions on validation data. save predictions on test data.

# Datasets Available
- train_data: {DATA_DIR}/train.csv
- test_data: {DATA_DIR}/test.csv, no label data.
- additional data: {DATA_DIR}/features.csv, to merge on train, test.
- stores data: {DATA_DIR}/stores.csv, to merge on train, test.
